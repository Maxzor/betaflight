...
#define USBD_PRODUCT_STRING     "PixracerF4"
...
//#define MS5611_I2C_INSTANCE     I2CDEV_1 ***PR wonders - Baro is on FRAM/SPI2***

#define USE_SDCARD

//#define SDCARD_DETECT_INVERTED
//#define SDCARD_DETECT_PIN                   no detect pin on Pixracer (because Dronecode needs SDCard to flash firmware on Pixhawk/Pixracer (FMUv2/4))
...
// #define AFATFS_USE_INTROSPECTIVE_LOGGING ***PR wonders ? ***
...
/*/* ***PR wonders - stock from Bluejay target, there is no dedicated led output on Pixracer... ***
#define LED_STRIP
